<p align="center">
  <img src="https://revealuistudio.com/revealui-mark.svg" alt="RevealUI Circuit-R" width="72" height="72">
</p>

# RevealUI Studio

A one-person studio in Maryville, Tennessee. I take paid work on a Consultation, a Pilot, or a Launch. I work in Maryville, Alcoa, and Knoxville, and on a call.
...
## Open tools · GitHub + [docs.revealui.com](https://docs.revealui.com)
...
License posture: 25 of 32 packages are MIT forever. The 5 Pro packages (`@revealui/ai`, `@revealui/engines`, `@revealui/harnesses`, `@revealui/mcp`, `@revealui/services`) are Fair Source ([FSL-1.1-MIT](https://fsl.software/)) and convert to MIT 2 years after each release.
